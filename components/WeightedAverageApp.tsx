...
export default function WeightedAverageApp() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      {/* Toolbar */}
      <div className="flex items-center justify-between mb-4" data-exclude-export>
        {/* Options toggle — left side */}
        <button
              ...
              >
                {saveStatus === "saving" ? (
                  ...
                  <>
                    ...
                    Save
                    {rememberLocation && (
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-3 h-3 text-blue-200">
              ...
              <button
                ...
                className={`flex items-center py-2 px-1.5 rounded-r-xl transition-all duration-200 cursor-pointer ${
                  saveStatus === "done"
                    ...
                    : "bg-blue-600 text-white hover:bg-blue-700 border-l border-blue-500"
                }`}
                title="Save options"
              >
      ...
      <div className="bg-white rounded-2xl border border-slate-200/60 shadow-xl shadow-slate-900/[0.04] w-fit mx-auto">
        ...
        <div ref={gridRef} className="bg-white rounded-2xl px-6 py-5">
          <input
            ...
            className="block w-full text-center text-xl font-bold text-slate-800 mb-5 bg-transparent outline-none focus:ring-2 focus:ring-blue-300/50 rounded-lg px-3 py-1.5 border-0 placeholder:text-slate-300"
            spellCheck={false}
