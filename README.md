...
2. Below the card, use **Undo / Redo**, **Copy**, **Save**, and the **menu** (hamburger): the hamburger opens options for decimal precision, layout, theme (four presets plus custom), and templates.
